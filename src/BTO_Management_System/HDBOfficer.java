...
public class HDBOfficer extends Applicant {
    ...
    private HDBManager assignedManager; // Reference to the assigned manager
    ...
    public void handleApplication(Application application, ApplicationStatus newStatus) {
        if (assignedManager != null) {
            assignedManager.handleApplication(application, newStatus);
        } else {
            System.out.println("Error: No assigned manager to handle the application.");
        }
    }
